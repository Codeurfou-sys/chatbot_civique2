...
1. [Ouvrir la recherche de proximité](https://codeurfou-sys.github.io/Chatbot_civique2/recherche-centres/)
...
1. [Saisir ma commune ou mon code postal](https://codeurfou-sys.github.io/Chatbot_civique2/recherche-centres/)
2. [Choisir un centre par région](SCR_PASS_REGIONS)
3. [Retour au module](SCR_PASS_MENU)
...
1. [Saisir mon code postal](https://codeurfou-sys.github.io/Chatbot_civique2/recherche-centres/)
2. [Choisir un centre par région](SCR_PASS_REGIONS)
3. [Retour au module](SCR_PASS_MENU)
...
1. [Ouvrir la recherche](https://codeurfou-sys.github.io/Chatbot_civique2/recherche-centres/)
