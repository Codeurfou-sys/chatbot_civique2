...
Je peux expliquer une notion du programme ou vous orienter vers la bonne rubrique. Aucune réponse n’est inventée : je m’appuie uniquement sur les contenus du chatbot.
...
J’ai trouvé une notion correspondant à votre question : **Laïcité**.

1. [Afficher l’explication](SCR_QL_GLO0080)
2. [Poser une autre question](SCR_QL_RESET)
`@qlTrouvee = true`
`endif`
...
`if !@qlTrouvee && (@qlNormalisee.includes("loire") || @qlNormalisee.includes("rhone"))`
J’ai trouvé une notion correspondant à votre question : **Seine**.
...
`if !@qlTrouvee && (@qlNormalisee.includes("score") || @qlNormalisee.includes("32 sur 40") || @qlNormalisee.includes("80 pour cent") || @qlNormalisee.includes("reussir examen"))`
